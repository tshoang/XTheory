...
public class TheorySemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     ((comment=ML_COMMENT | comment=SL_COMMENT)? name=ID (rrule=RewriteRule | irule=InferenceRule))
	 */
	 ...
	 *         ((types+=Type | operators+=Operator | axioms+=Axiom | theorems+=Theorem)? (variables+=Variable* rules+=Rule)?)+
	 *     )
	 */
