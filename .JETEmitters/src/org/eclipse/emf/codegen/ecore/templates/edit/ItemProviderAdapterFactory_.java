...
public class ItemProviderAdapterFactory_
{
  ...
  protected final String TEXT_104 = " editingDomain;" + NL + "" + NL + "\t\t\t/**" + NL + "\t\t\t * Creates the switch for populating child descriptors in the given domain." + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL + "\t\t\tCreationSwitch(";
  ...
  protected final String TEXT_113 = NL + "\t\t\tEAnnotation annotation = null;";
  protected final String TEXT_114 = NL + NL + "\t\t\t\t\tnewChildDescriptors.add" + NL + "\t\t\t\t\t\t(createChildParameter" + NL + "\t\t\t\t\t\t\t(";
  protected final String TEXT_115 = "," + NL + "\t\t\t\t\t\t \t";
  protected final String TEXT_116 = ".createEntry" + NL + "\t\t\t\t\t\t\t\t(";
  ...
  protected final String TEXT_124 = NL + "\t\t\t\tnewChildDescriptors.add" + NL + "\t\t\t\t\t(createChildParameter" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_125 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_126 = ".createEntry" + NL + "\t\t\t\t\t\t\t(";
  ...
  protected final String TEXT_138 = NL + "\t\t\t\tannotation = ";
  protected final String TEXT_139 = ".getEAnnotation(\"org.eventb.emf.core.extendedMetaClasses\");" + NL + "\t\t\t\tif (annotation == null  || annotation.getReferences().contains(object.eClass()))" + NL + "\t\t\t\t\tnewChildDescriptors.add" + NL + "\t\t\t\t\t\t(createChildParameter" + NL + "\t\t\t\t\t\t\t(";
  ...
  protected final String TEXT_147 = NL + "\t\t\t\tnewChildDescriptors.add" + NL + "\t\t\t\t\t(createChildParameter" + NL + "\t\t\t\t\t\t(";
  ...
  protected final String TEXT_157 = " // TODO: ensure this is a valid literal value";
  protected final String TEXT_158 = NL;
  protected final String TEXT_159 = NL + "\t\t\t\treturn null;" + NL + "\t\t\t}" + NL + " ";
  protected final String TEXT_160 = NL + "\t\t\t/**" + NL + "\t\t\t * <!-- begin-user-doc -->" + NL + "\t\t\t * <!-- end-user-doc -->" + NL + "\t\t\t * @generated" + NL + "\t\t\t */" + NL + "\t\t\tprotected ";
  protected final String TEXT_161 = " createChildParameter(Object feature, Object child)" + NL + "\t\t\t{" + NL + "\t\t\t\treturn new ";
  protected final String TEXT_162 = "(null, feature, child);" + NL + "\t\t\t}" + NL + "" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic ";
  protected final String TEXT_163 = " getNewChildDescriptors(Object object, ";
  protected final String TEXT_164 = " editingDomain)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_165 = " result = new ";
  protected final String TEXT_166 = "();" + NL + "\t\t   new CreationSwitch(result, editingDomain).doSwitch((";
  protected final String TEXT_167 = ")object);" + NL + "\t\t   return result;" + NL + "\t\t}" + NL + "" + NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tpublic ";
  protected final String TEXT_168 = " getResourceLocator()" + NL + "\t\t{" + NL + "\t\t\treturn ";
  protected final String TEXT_169 = ".INSTANCE;" + NL + "\t\t}" + NL + "\t}" + NL;
 ...
 */
    ...
    genModel.addImport("org.eclipse.emf.ecore.EAnnotation");
