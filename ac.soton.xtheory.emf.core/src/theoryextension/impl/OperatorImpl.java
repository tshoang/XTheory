 ...
 *   <li>{@link theoryextension.impl.OperatorImpl#getRecursivities <em>Recursivities</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OperatorImpl extends EventBNamedCommentedActionElementImpl implements Operator {
	/**
	 ...
	 * @ordered
	 */
	protected static final OperatorType TYPE_EDEFAULT = OperatorType.EXPRESSION;
	...
	/**
	 * The cached value of the '{@link #getRecursivities() <em>Recursivities</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRecursivities()
	 * @generated
	 * @ordered
	 */
	protected EList<Recursivity> recursivities;
	 ...
	 * @generated
	 */
	public EList<Recursivity> getRecursivities() {
		if (recursivities == null) {
			recursivities = new EObjectResolvingEList<Recursivity>(Recursivity.class, this, TheoryextensionPackage.OPERATOR__RECURSIVITIES);
		}
		return recursivities;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TheoryextensionPackage.OPERATOR__CASES:
				return getCases();
			case TheoryextensionPackage.OPERATOR__RECURSIVITIES:
				return getRecursivities();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TheoryextensionPackage.OPERATOR__CASES:
				...
				return;
			case TheoryextensionPackage.OPERATOR__RECURSIVITIES:
				getRecursivities().clear();
				getRecursivities().addAll((Collection<? extends Recursivity>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TheoryextensionPackage.OPERATOR__RECURSIVITIES:
				return recursivities != null && !recursivities.isEmpty();
		}
