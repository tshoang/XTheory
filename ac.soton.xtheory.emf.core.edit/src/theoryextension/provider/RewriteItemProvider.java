...
/**
 * This is the item provider adapter for a {@link theoryextension.Rewrite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RewriteItemProvider extends EventBNamedCommentedElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	protected void addFormulaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rewrite_Formula_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rewrite_Formula_feature", "_UI_Rewrite_type"),
				 TheoryextensionPackage.Literals.REWRITE__FORMULA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Rewrite)object).getName();
