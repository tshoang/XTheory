		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRuleAccess().getCommentAlternatives_0_0(), "rule__Rule__CommentAlternatives_0_0");
					...
					put(grammarAccess.getTheoryAccess().getGroup_4_4_1(), "rule__Theory__Group_4_4_1__0");
					...
					put(grammarAccess.getTheoryAccess().getTypesAssignment_4_0_1(), "rule__Theory__TypesAssignment_4_0_1");
					put(grammarAccess.getTheoryAccess().getOperatorsAssignment_4_1_1(), "rule__Theory__OperatorsAssignment_4_1_1");
					put(grammarAccess.getTheoryAccess().getAxiomsAssignment_4_2_1(), "rule__Theory__AxiomsAssignment_4_2_1");
					put(grammarAccess.getTheoryAccess().getTheoremsAssignment_4_3_1(), "rule__Theory__TheoremsAssignment_4_3_1");
					put(grammarAccess.getTheoryAccess().getVariablesAssignment_4_4_1_1(), "rule__Theory__VariablesAssignment_4_4_1_1");
					put(grammarAccess.getTheoryAccess().getRulesAssignment_4_4_2(), "rule__Theory__RulesAssignment_4_4_2");
					...
					put(grammarAccess.getTypeAccess().getConstructorsAssignment_2_4(), "rule__Type__ConstructorsAssignment_2_4");
					put(grammarAccess.getTypeAccess().getConstructorsAssignment_2_5_1(), "rule__Type__ConstructorsAssignment_2_5_1");
					...
					put(grammarAccess.getRuleAccess().getCommentAssignment_0(), "rule__Rule__CommentAssignment_0");
					put(grammarAccess.getRuleAccess().getNameAssignment_2(), "rule__Rule__NameAssignment_2");
					put(grammarAccess.getRuleAccess().getRruleAssignment_4_0(), "rule__Rule__RruleAssignment_4_0");
					put(grammarAccess.getRuleAccess().getIruleAssignment_4_1(), "rule__Rule__IruleAssignment_4_1");
