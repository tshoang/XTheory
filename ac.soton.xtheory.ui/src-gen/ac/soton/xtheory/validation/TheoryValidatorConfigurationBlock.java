...
public class TheoryValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("Theory");
		if (section == null) {
			return dialogSettings.addNewSection("Theory");
		}
		return section;
	}
}
